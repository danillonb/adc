            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"><b>Nova Assinatura</b></div>
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" action="{{ route('cria_assinatura') }}">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group{{ $errors->has('cargo') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <select id="cargo" type="text" class="form-control" name="cargo" >
                                                    <option value="">Selecione a Função Ministerial</option>
                                        ...
                                        <div class="form-group{{ $errors->has('registro') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input id="registro" type="text" class="form-control" placeholder="Digite a número do registro" name="registro" value="{{ old('registro') }}" autofocus>
